...
| `git rebase` | `grb <branch name>` | No| [:information_source:](https://git-scm.com/docs/git-rebase) |
| `git remote set-url origin` | `gremote <repourl>` | No| [:information_source:](https://git-scm.com/docs/git-remote) |
----
## To Contribute
